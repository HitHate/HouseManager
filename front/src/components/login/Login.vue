  ...
  <div class="bigBox">
    <div class="box" ref="box">
      ...
      <div class="pre-box">
        ...
        <p>JOIN US!</p>
        <div class="img-box">
          <img src="@/assets/img/login/waoku.jpg" alt="" id="avatar" />
        </div>
      </div>
      <!-- 注册盒子 -->
      ...
      <div class="login-form">
        ...
        <div class="btn-box">
          ...
          <button @click="super1">跳转管理员登录</button>
        </div>
      </div>
    </div>
  </div>
...
const rules = reactive({
  ...
  type: [{ required: true, message: "请选择登录身份", trigger: "change" }],
  confirmPassword: [
      ...
      post("http://127.0.0.1:8081/api/user/login", loginForm)
        .then((resp) => {
          if (resp.code === 200) {
            ...
            window.sessionStorage.setItem("token-U", JSON.stringify(resp.data));
            ...
            if (resp.data.type == "用户") {
              ...
              router.push("/u");
            	...
            	console.log("----------------------------登录页面");
              adminInfo1.changeInfo(resp.data);
              router.push("/");
            }
          } else {
            loginForm.username = "";
